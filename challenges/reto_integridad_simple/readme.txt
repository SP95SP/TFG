...
Simula una máquina Linux multiusuario. El objetivo es escalar privilegios desde un usuario básico, obtener la flag del usuario admin y evitar ser detectado.
En esta versión, si se detecta acceso a admin, solo se muestra una alarma en el log, pero el entorno continúa activo.
...
watcher.sh
Script que monitoriza el archivo de logs. Si detecta acceso a admin, muestra una alarma en el log, pero no apaga el contenedor.
